...
// const Core = dynamic(() => import('@core_modules/thanks/pages/default/core'), { ssr: false });

const Page = (props) => (
    <Core Skeleton={Skeleton} Content={Content} ErrorInfo={ErrorInfo} {...props} />
);
...
Page.getInitialProps = async (ctx) => {
    ...
    return {
        query: ctx.query,
        checkoutData: (typeof checkoutData === 'string' ? JSON.parse(checkoutData) : checkoutData) ?? undefined,
