...
export const addProductsToCartCustom = gql`
  mutation addProductsToCartCustom(
    $cartItems: [CartItemInput!]!
  ) {
    addProductsToCartCustom(cartItems: $cartItems) {
      cart {
        id
      }
      user_errors {
...
export const writeProductViewReport = gql`
    mutation writeProductViewReport($productId: Int!) {
        writeProductViewReport(product_id: $productId) {
            status
            message
        }
    }
...
export const writeCartProductReport = gql`
    mutation writeCartProductReport($productId: [Int!]) {
        writeCartProductReport(product_id: $productId) {
            status
            message
        }
    }
