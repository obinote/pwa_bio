    ...
    return (
        <div className={styles.root}>
            <div className={styles.authBlock}>
                <Typography className={styles.labelForm} variant="span">{t('customer:haveAccount')}</Typography>
                <Button fullWidth className={styles.btnSignIn} href="/customer/account/login">
                    <Typography variant="span" type="bold" letter="uppercase">
                        {t('common:button:login')}
                    </Typography>
                </Button>

                <Typography className={styles.labelForm} variant="span">{t('customer:notHaveAccount')}</Typography>
                <Button fullWidth className={styles.btnSignUp} variant="outlined" href="/customer/account/create">
                    <Typography variant="span" type="bold" letter="uppercase">
