...
import MessageContainerBot from '@core_modules/customer/plugins/ChatContent/components/MessageContainerBot';
                                    ...
                                    <>
                                        ...
                                        <div className={styles.messageContent}>
                                            <div style={{ textAlign: 'center' }}>
                                                <img style={{ width: '125px' }} src="/assets/img/start_chat.png" alt="start chat" />
                                                <p className={styles.emptyText}>Pilih salah satu Admin MedBiz Care untuk memulai chat</p>
                                            </div>
                                        </div>
                                    </>
                                )}
