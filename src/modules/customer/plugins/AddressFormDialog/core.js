...
const AddressFormDialog = (props) => {
    ...
    const ValidationAddress = {
        // address_label: Yup.string().required(t('validate:addressLabel:required')),
    ...
    React.useMemo(() => {
        if (open) {
            formik.setFieldValue('address_label', address_label);
            formik.setFieldValue('firstname', firstname);
            formik.setFieldValue('lastname', lastname);
            formik.setFieldValue('company', company);
            formik.setFieldValue('fax', fax);
            formik.setFieldValue('erp_id_address', erp_id_address);
