...
const ProductItem = (props) => {
    ...
    const regex = /\/\/.+\/(.+)/g;
    const regexHtml = /\/\/.+\/(.+)\.html/g;
    const subst = '/$1';
    const urlKey = url?.includes('.html') ? url?.replace(regexHtml, subst) : url?.replace(regex, subst);
    ...
    const [price, setPrice] = React.useState({
        ...
        priceTiersCustom: other.tier_prices_custom,
                ...
                <div className={classNames(styles.itemContainer, 'item-product', className, showQuickView ? styles.quickView : '')}>
                    <div className={styles.itemInnerContainer}>
                        ...
                        <div className={styles.imgItem}>
                            ...
                            <ImageProductView t={t} handleClick={handleClick} spesificProduct={spesificProduct} smallImage={smallImage} {...other} />
                        </div>
                        <div className={styles.detailItem}>
                            {/* eslint-disable-next-line max-len */}
                            <DetailProductView t={t} {...DetailProps} {...other} catalogList={catalogList} enableWishlist={false} enableProductCompare={false} />
                    ...
                    <div className="col-xs-6 col-sm-6 col-md-8 col-lg-9">
                        <div className="row start-xs">
                            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <DetailProductView t={t} {...DetailProps} {...other} enableWishlist={false} enableProductCompare={false} />
                            </div>
                            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                {showOption ? (
                                    <ConfigurableOpt
