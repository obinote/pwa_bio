...
export const getCategoryUrlPath = gql`
    query getCategoryUrlPath($id: String!) {
...
export const getCategoryPrivateEvent = gql`
    query getCategoryPrivateEvent($category_id: Int!) {
        getCategoryPrivateEvent(
