...
CustomTypography.propTypes = {
    ...
    type: PropTypes.oneOf(['bold', 'italic', 'semiBold', 'regular', 'normal']),
    ...
    color: PropTypes.oneOf(['red', 'green', 'orange', 'white', 'default', 'gray', 'black']),
    size: PropTypes.oneOf(['5', '6', '8', '10', '12', '14', '16', '18', '0']),
};
