...
const SimpleProductTypePrice = ({
    ...
    return (
        <>
            {/* case 9 */}
            <div className="special-price-wrapper">
                <Typography
                    variant="span"
                    type="bold"
                    letter="capitalize"
                    className={classNames(styles.noMargin, styles.finalPrice, 'final-price')}
                >
                    {
                ...
                </Typography>
                {
                    validSpecial ? (
                        <Typography
                            variant="span"
                            letter="capitalize"
                            className={classNames(styles.noMargin, styles.oldPrice, 'price_text', 'old-price')}
                        >
                            <strike>{formatPrice(regularPrice.value + otherPrice, regularPrice.currency)}</strike>
                        </Typography>
                    ) : null
