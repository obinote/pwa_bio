...
const ButtonQty = ({
    ...
    return (
        <div className={styles.box}>
            <div className={classNames(styles.qtyButton, styles.minus, disabledMin ? styles.disabled : '')} onClick={handleMinus}>-</div>
            <input disabled={disabled} value={localValue} className={styles.input} type="number" onChange={handleLocalChange} />
            <div className={classNames(styles.qtyButton, styles.plus, disableMax ? styles.disabled : '')} onClick={handlePlus}>+</div>
        </div>
    );
};
