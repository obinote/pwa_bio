...
mutation getToken(
  ...
  generateCustomerToken(username: $username, password: $password){
      token
    }
  }
`;
...
export const socialLogin = gql`
    mutation generateCustomerTokenSocialLogin(
        ...
        internalCreateSocialLogin(input: {
            username: $username, socialtoken: $socialtoken, firstname: $firstname, lastname: $lastname
        })
     {
    token
    }
