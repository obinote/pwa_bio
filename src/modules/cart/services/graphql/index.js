...
export const getCartCustomLazy = () => useLazyQuery(Schema.getCartCustom,
    {
        context: {
            request: 'internal',
        },
...
export const updateCartitemCustom = () => useMutation(Schema.updateCartitemCustom, {
    context: {
        request: 'internal',
    },
});

export const updateCartitemBulk = () => useMutation(Schema.updateCartitemBulk, {
    context: {
        request: 'internal',
    },
});
...
export const getRequisitionList = () => useQuery(Schema.getRequisitionList, {
    context: {
        request: 'internal',
    },
});

export const addRequisition = () => useMutation(Schema.addRequisition, {
    context: {
        request: 'internal',
    },
});

export const addItemToRequisitionList = () => useMutation(Schema.addItemToRequisitionList, {
    context: {
        request: 'internal',
    },
});

export const addQtyToRequisitionListItem = () => useMutation(Schema.addQtyToRequisitionListItem, {
    context: {
        request: 'internal',
    },
});

export const requestNegotiableQuote = () => useMutation(Schema.requestNegotiableQuote, {
    context: {
        request: 'internal',
    },
});
